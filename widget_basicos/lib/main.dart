...
import 'layouts/styles/misEstilos.dart';

void main() {
  runApp(MainApp(titulo: "Ejemplos Widgets", estilo: miEstilo1));
}

class MainApp extends StatelessWidget {
  MainApp({super.key, required this.titulo, required this.estilo});
  String? titulo;
  TextStyle? estilo;
  @override
